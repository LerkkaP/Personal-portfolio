...
const Card = () => {
    ...
    return (
        <div className="max-w-sm rounded overflow-hidden shadow-md shadow-blue-400 mx-5">
            <div className="group h-96 w-80">
                ...
                <div className="absolute inset-0 h-full w-full px-12 text-center text-slate-200 back">
                    <div className="px-6 py-8">
                        ...
                        <button className='absolute bottom-2 right-2' onClick={handleFlip}><FlipToFrontIcon color='primary'/></button>                
